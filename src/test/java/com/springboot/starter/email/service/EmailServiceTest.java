...
public class EmailServiceTest {
    ...
    @Test
    public void simpleEmailMessageTest()throws AddressException,MessagingException
    {
     ...
     */
    private Email prepareMessage(Boolean attachmentIncluded)throws AddressException
    {
        InternetAddress[] toList = new InternetAddress[1];
        toList=InternetAddress.parse("moeentabrizi@gmail.com");
